...
public partial class Page_ChoGolden : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                String cmdStr = "SELECT * FROM THUCUNG TC, GIONG G WHERE TC.MAGIONG = G.MAGIONG AND TC.MALOAI = 'DOG' AND TC.MAGIONG = 'GOLDEN'";
