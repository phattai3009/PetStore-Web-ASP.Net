<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ChoCorgi.aspx.cs" Inherits="Page_ChoCorgi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            <h1 class="title-background"><span class="title">Thú Cưng: Chó corgi</span> </h1>
            <hr />
            <div>
