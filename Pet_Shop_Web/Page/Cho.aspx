<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Cho.aspx.cs" Inherits="Page_Cho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            <h1 class="title-background"><span class="title">Thú Cưng: Chó</span> </h1>
            <hr />
            <div>
                <asp:DataList ID="DL_TC" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="1160px" style="padding-left:10px" OnItemCommand="DL_TC_ItemCommand">
                    <ItemTemplate>
