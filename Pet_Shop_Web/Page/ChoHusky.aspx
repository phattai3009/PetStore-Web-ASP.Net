<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="ChoHusky.aspx.cs" Inherits="Page_ChoHusky" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            <h1 class="title-background"><span class="title">Thú Cưng: Chó husky</span> </h1>
            <hr />
            <div>
