<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="SanPham.aspx.cs" Inherits="Page_SanPham" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            ...
            <hr />
            <div>
                <asp:DataList ID="DL_TC" runat="server" RepeatColumns="4" RepeatDirection="Horizontal" Width="1140px" style="padding-left:10px" OnItemCommand="DataListCTSP_ItemCommand">
                    <ItemTemplate>
