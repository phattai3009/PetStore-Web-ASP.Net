<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="Chim.aspx.cs" Inherits="Page_Chim" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <div>
            <h1 class="title-background"><span class="title">Thú Cưng: Chim</span> </h1>
            <hr />
            <div>
